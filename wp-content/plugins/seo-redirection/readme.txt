...
Tags: post, admin, seo, pages, manage, 301, 404, redirect, permalink, redirection, seo redirection, post redirect, 404 to 301
...
* Build all types of redirection for your site 301,302 or 307 easily.
...
Ease of use.  Redirections are automatically created when a post URL changes, and it is a lot easier to manually add redirections than to hack around a .htaccess.
