	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="intro">
					<p>
						This <a href="http://sitemaps.org">XML Sitemap</a> is designed for search engines and crawlers such as <a href="http://www.google.com">Google</a>, <a href="http://www.bing.com/">BING</a> and <a href="http://www.yahoo.com">YAHOO</a>.<br />
