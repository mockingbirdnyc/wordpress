...
class tz_ad_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $title )
			echo $before_title . $title . $after_title;
                        ...
                        echo '<div class="widget-body clear">';
                    }
		...
		/* Display Ad 1. */
		if ( $link1 )
			$ads[] = '<li><a href="' . $link1 . '" target="_blank"/><img src="' . $ad1 . '"  alt="" /></a></li>';
		...
		/* Display Ad 3. */
		if ( $link3 )
			$ads[] = '<li><a href="' . $link3 . '" target="_blank"/><img src="' . $ad3 . '"  alt="" /></a></li>';
		...
		/* Display Ad 4. */
		if ( $link4 )
			$ads[] = '<li><a href="' . $link4 . '" target="_blank"/><img src="' . $ad4 . '"  alt="" /></a></li>';
		...
		/* Display Ad 5. */
		if ( $link5 )
			$ads[] = '<li><a href="' . $link5 . '" target="_blank"/><img src="' . $ad5 . '"  alt="" /></a></li>';
		...
		/* Display Ad 6. */
		if ( $link6 )
			$ads[] = '<li><a href="' . $link6 . '" target="_blank"/><img src="' . $ad6 . '"  alt="" /></a></li>';
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => 'Our Sponsors',
		'ad1' => get_bloginfo('template_directory')."/images/banner-125x125.gif",
		'link1' => 'http://www.ormanclark.com',
		'ad2' => get_bloginfo('template_directory')."/images/banner-125x125.gif",
		'link2' => 'http://www.ormanclark.com',
		'ad3' => '',
		'link3' => '',
		'ad4' => '',
		'link4' => '',
