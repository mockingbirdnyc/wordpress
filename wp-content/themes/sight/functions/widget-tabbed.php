...
if (is_active_widget(false, false, 'tz_tab_widget') && (!is_admin())){
		...
		wp_register_script('tabbed', get_bloginfo('template_directory').'/js/tabbed-widget.js', array('jquery-ui-tabs'));
		...
		echo '<div id="tabs">';
			...
			echo '<div id="tabs-1" class="tab tab-popular">';
				echo '<ul>';
                                        ...
                                        $popargs = array(
										'meta_key' => '_slide_cb_single3',
										'meta_value' => 'yes',
										'showposts' => '5',
										'orderby' => 'rand'
										);
					
					$popPosts = new WP_Query($popargs);
