...
?>">
        ...
        <?php
			...
			if ( is_post_type_archive( 'ct_sermon' ) || is_tax('sermon_speaker') || is_tax('sermon_format') || is_tax('sermon_series') || is_tax('sermon_topic') ) wp_enqueue_script('selectbox','http://select-box.googlecode.com/svn/tags/0.2/jquery.selectbox-0.2.min.js', 'jquery', false);
	...
	<body <?php body_class(); ?> >
		<div class="ribbon">
            <div id="newhere"><a href="#">New Here?</a></div>
        </div>
		<div class="wrapper<?php if ( (is_single() | is_home() | is_category() | is_tag() | is_author() | is_archive() ) && !is_post_type_archive('ct_sermon') && $post_type != 'ct_sermon' && !is_tax('sermon_speaker') && !is_tax('sermon_series') && !is_tax('sermon_format') && !is_tax('sermon_topic') ) { echo ' blog'; $is_blog = true; } ?>">
 ...
 $children = wp_list_pages("title_li=&child_of=".$post->post_parent."&echo=0");}
  ...
  <?php } ?>
         ...
         <div id="social">
                    <span class="typcn typcn-mail">&nbsp;</span>&nbsp;<span class="typcn typcn-social-twitter">&nbsp;</span>&nbsp;<span class="typcn typcn-social-instagram">&nbsp;</span>&nbsp;<span class="typcn typcn-social-facebook">&nbsp;</span>&nbsp;
          </div>
