...
<form class="input2a clearfix" action="https://www.paypal.com/cgi-bin/webscr" method="post">
...
<form class="input2 clearfix" action="https://www.paypal.com/cgi-bin/webscr" method="post">
...
<div><span class="inputtext">$</span><input class="input3" type="text" name="a3" id="a3" value="" size="10" /> <span class="text">Please enter recurring amount to be charged/debited from your credit or debit card each month <span id="flash">(Minimum of $5)</span>.</span> </div>
<br />
...
function validate_form ( ) {
	...
	valid = true;
	if ( jQuery("#a3").val() < 5 ){
		alert ( "Donation minimum is $5 a month" );
		valid = false;
	}
	return valid;
}
